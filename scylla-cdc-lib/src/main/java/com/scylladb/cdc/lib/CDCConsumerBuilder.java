...
public final class CDCConsumerBuilder {
    ...
    private CDCConsumerBuilder(Session session, ChangesConsumer consumer, Set<TableName> tables) {
    ...
    public static CDCConsumerBuilder builder(Session session, ChangesConsumer consumer, Set<TableName> tables) {
